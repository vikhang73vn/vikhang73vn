...
<head>
    ...
    <![endif]-->
    <%--    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.11.2/css/all.css">&ndash;%&gt;--%>
                ...
                <div class="product-content-right">
                    <div class="woocommerce">
                        <form method="post" action="#">
                            <table cellspacing="0" class="shop_table cart" id="cart">
                                <thead>
                                <tr>
                                ...
                                <tbody>
                                <c:set var="prducts" value="${cart.productList}"/>
                                <c:forEach items="${prducts}" var="product">
                                    <tr class="cart_item">
                                        <td class="product-remove">
                                            <a title="Remove this item" class="remove" pid="${product.id}">×</a>
                                        </td>
                                        ...
                                        <td class="product-quantity">
                                            <div class="quantity buttons_added">
                                                <input type="number" size="4" class="input-text qty text" title="Qty"
                                                       pid="${product.id}" value="${product.quantitySold}" min="0"
                                                       step="1">
                                            </div>
                                        </td>
                                        <td class="product-subtotal">
                                            <span class="amount">${product.totalMoney}</span>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
...
<script>
    ...
    function loadCart(cart) {
        ...
        for (const x in cart.productList) {
            sum += cart.productList[x].price * cart.productList[x].quantitySold;
        }
        $(".total-cart").html(sum);
    }
